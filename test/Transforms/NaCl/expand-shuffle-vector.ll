...
define <4 x i32> @test_splat_lo_4xi32(<4 x i32> %lhs, <4 x i32> %rhs) {
  ...
  ; CHECK-NEXT: %2 = insertelement <4 x i32> undef, i32 %1, i32 0
  ; CHECK-NEXT: %3 = extractelement <4 x i32> %lhs, i32 0
  ; CHECK-NEXT: %4 = insertelement <4 x i32> %2, i32 %3, i32 1
  ; CHECK-NEXT: %5 = extractelement <4 x i32> %lhs, i32 0
  ; CHECK-NEXT: %6 = insertelement <4 x i32> %4, i32 %5, i32 2
  ; CHECK-NEXT: %7 = extractelement <4 x i32> %lhs, i32 0
...
define <4 x i32> @test_splat_hi_4xi32(<4 x i32> %lhs, <4 x i32> %rhs) {
  ...
  ; CHECK-NEXT: %4 = insertelement <4 x i32> %2, i32 %3, i32 1
  ; CHECK-NEXT: %5 = extractelement <4 x i32> %rhs, i32 0
  ; CHECK-NEXT: %6 = insertelement <4 x i32> %4, i32 %5, i32 2
  ; CHECK-NEXT: %7 = extractelement <4 x i32> %rhs, i32 0
  ; CHECK-NEXT: %8 = insertelement <4 x i32> %6, i32 %7, i32 3
...
define <4 x i32> @test_id_lo_4xi32(<4 x i32> %lhs, <4 x i32> %rhs) {
  ...
  ; CHECK-NEXT: %4 = insertelement <4 x i32> %2, i32 %3, i32 1
  ; CHECK-NEXT: %5 = extractelement <4 x i32> %lhs, i32 2
  ; CHECK-NEXT: %6 = insertelement <4 x i32> %4, i32 %5, i32 2
  ; CHECK-NEXT: %7 = extractelement <4 x i32> %lhs, i32 3
  ; CHECK-NEXT: %8 = insertelement <4 x i32> %6, i32 %7, i32 3
...
define <4 x i32> @test_id_hi_4xi32(<4 x i32> %lhs, <4 x i32> %rhs) {
  ...
  ; CHECK-NEXT: %4 = insertelement <4 x i32> %2, i32 %3, i32 1
  ; CHECK-NEXT: %5 = extractelement <4 x i32> %rhs, i32 2
  ; CHECK-NEXT: %6 = insertelement <4 x i32> %4, i32 %5, i32 2
  ; CHECK-NEXT: %7 = extractelement <4 x i32> %rhs, i32 3
  ; CHECK-NEXT: %8 = insertelement <4 x i32> %6, i32 %7, i32 3
...
define <4 x i32> @test_interleave_lo_4xi32(<4 x i32> %lhs, <4 x i32> %rhs) {
  ...
  ; CHECK-NEXT: %3 = extractelement <4 x i32> %rhs, i32 0
  ; CHECK-NEXT: %4 = insertelement <4 x i32> %2, i32 %3, i32 1
  ; CHECK-NEXT: %5 = extractelement <4 x i32> %lhs, i32 1
  ; CHECK-NEXT: %6 = insertelement <4 x i32> %4, i32 %5, i32 2
  ; CHECK-NEXT: %7 = extractelement <4 x i32> %rhs, i32 1
  ; CHECK-NEXT: %8 = insertelement <4 x i32> %6, i32 %7, i32 3
...
define <2 x i32> @test_narrow_4xi32(<4 x i32> %lhs, <4 x i32> %rhs) {
  ...
  ; CHECK-NEXT: %1 = extractelement <4 x i32> %lhs, i32 0
  ; CHECK-NEXT: %2 = insertelement <2 x i32> undef, i32 %1, i32 0
  ; CHECK-NEXT: %3 = extractelement <4 x i32> %rhs, i32 0
  ; CHECK-NEXT: %4 = insertelement <2 x i32> %2, i32 %3, i32 1
...
define <8 x i32> @test_widen_4xi32(<4 x i32> %lhs, <4 x i32> %rhs) {
  ...
  ; CHECK-NEXT: %2 = insertelement <8 x i32> undef, i32 %1, i32 0
  ; CHECK-NEXT: %3 = extractelement <4 x i32> %rhs, i32 2
  ; CHECK-NEXT: %4 = insertelement <8 x i32> %2, i32 %3, i32 1
  ; CHECK-NEXT: %5 = extractelement <4 x i32> %rhs, i32 1
  ; CHECK-NEXT: %6 = insertelement <8 x i32> %4, i32 %5, i32 2
  ; CHECK-NEXT: %7 = extractelement <4 x i32> %rhs, i32 0
  ; CHECK-NEXT: %8 = insertelement <8 x i32> %6, i32 %7, i32 3
  ; CHECK-NEXT: %9 = extractelement <4 x i32> %lhs, i32 3
  ; CHECK-NEXT: %10 = insertelement <8 x i32> %8, i32 %9, i32 4
  ; CHECK-NEXT: %11 = extractelement <4 x i32> %lhs, i32 2
  ; CHECK-NEXT: %12 = insertelement <8 x i32> %10, i32 %11, i32 5
  ; CHECK-NEXT: %13 = extractelement <4 x i32> %lhs, i32 1
  ; CHECK-NEXT: %14 = insertelement <8 x i32> %12, i32 %13, i32 6
  ; CHECK-NEXT: %15 = extractelement <4 x i32> %lhs, i32 0
  ; CHECK-NEXT: %16 = insertelement <8 x i32> %14, i32 %15, i32 7
