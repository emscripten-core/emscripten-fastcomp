...
; C4xi1: @[[C1:[_a-z0-9]+]] = internal constant <4 x i1> <i1 false, i1 true, i1 false, i1 true>, align 4
; C4xi1: @[[C2:[_a-z0-9]+]] = internal constant <4 x i1> <i1 true, i1 false, i1 true, i1 false>, align 4
...
; C8xi1: @[[C1:[_a-z0-9]+]] = internal constant <8 x i1> <i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true>, align 8
; C8xi1: @[[C2:[_a-z0-9]+]] = internal constant <8 x i1> <i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false>, align 8
...
; C16xi1: @[[C1:[_a-z0-9]+]] = internal constant <16 x i1> <i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true>, align 16
; C16xi1: @[[C2:[_a-z0-9]+]] = internal constant <16 x i1> <i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false, i1 true, i1 false>, align 16
