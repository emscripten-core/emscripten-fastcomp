...
; CHECK-NEXT:    vst1.{{[0-9]+}} {d{{[0-9]+}}[3]}, [r0]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst1.{{[0-9]+}} {d{{[0-9]+}}[2]}, [r0:16]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst1.{{[0-9]+}} {d{{[0-9]+}}[1]}, [r0:32]
  ret void
}
...
; CHECK-NEXT:    vld1.{{[0-9]+}} {d{{[0-9]+}}, d{{[0-9]+}}}, [r1]
  ...
  store i8 %tmp2, i8* %A, align 8
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst1.{{[0-9]+}} {d{{[0-9]+}}[1]}, [r0]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {d{{[0-9]+}}[1], d{{[0-9]+}}[1]}, [r0:16]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {d{{[0-9]+}}[1], d{{[0-9]+}}[1]}, [r0:32]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {d{{[0-9]+}}[1], d{{[0-9]+}}[1]}, [r0]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {d{{[0-9]+}}[0], d{{[0-9]+}}[0]}, [r0:64]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst3.{{[0-9]+}} {d{{[0-9]+}}[1], d{{[0-9]+}}[1], d{{[0-9]+}}[1]}, [r0]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst4.{{[0-9]+}} {d{{[0-9]+}}[1], d{{[0-9]+}}[1], d{{[0-9]+}}[1], d{{[0-9]+}}[1]}, [r0:32]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst4.{{[0-9]+}} {d{{[0-9]+}}[1], d{{[0-9]+}}[1], d{{[0-9]+}}[1], d{{[0-9]+}}[1]}, [r0]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst4.{{[0-9]+}} {d{{[0-9]+}}[1], d{{[0-9]+}}[1], d{{[0-9]+}}[1], d{{[0-9]+}}[1]}, [r0:128]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst4.{{[0-9]+}} {d{{[0-9]+}}[3], d{{[0-9]+}}[3], d{{[0-9]+}}[3], d{{[0-9]+}}[3]}, [r0:64]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst4.{{[0-9]+}} {d{{[0-9]+}}[0], d{{[0-9]+}}[0], d{{[0-9]+}}[0], d{{[0-9]+}}[0]}, [r0]
  ret void
}
...
; CHECK:         bic r1, r1, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {d{{[0-9]+}}[1], d{{[0-9]+}}[1]}, [r1], r2
