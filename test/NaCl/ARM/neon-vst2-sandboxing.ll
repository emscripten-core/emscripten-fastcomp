...
; CHECK-NEXT:    vst2.{{[0-9]+}} {{{d[0-9]+, d[0-9]+}}}, [r0:64]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {{{d[0-9]+, d[0-9]+}}}, [r0:128]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {{{d[0-9]+, d[0-9]+}}}, [r0]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {{{d[0-9]+, d[0-9]+, d[0-9]+, d[0-9]+}}}, [r0:64]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {{{d[0-9]+, d[0-9]+, d[0-9]+, d[0-9]+}}}, [r0:128]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {{{d[0-9]+, d[0-9]+, d[0-9]+, d[0-9]+}}}, [r0:256]
  ret void
}
...
; CHECK:         bic r0, r0, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {{{d[0-9]+, d[0-9]+, d[0-9]+, d[0-9]+}}}, [r0]
  ret void
}
...
; CHECK:         bic r1, r1, #-1073741824
; CHECK-NEXT:    vst2.{{[0-9]+}} {{{d[0-9]+, d[0-9]+}}}, [r1], r2
