...
; CHECK-NEXT:     166:6|    4: <0, 3, 0>             |    var @g0, align 4,
; CHECK-NEXT:     168:1|    6: <2, 4>                |      zerofill 4;
; CHECK-NEXT:     169:5|    4: <0, 0, 0>             |    var @g1, align 0,
; CHECK-NEXT:     171:0|    7: <3, 97, 98, 99, 100,  |      { 97,  98,  99, 100, 101, 102, 
; CHECK-NEXT:          |        101, 102, 103>       |       103}
; CHECK-NEXT:     179:2|    4: <0, 0, 0>             |    var @g2, align 0,
; CHECK-NEXT:     180:5|    8: <4, 6>                |      reloc %v2;
; CHECK-NEXT:     181:7|    4: <0, 0, 0>             |    var @g3, align 0,
; CHECK-NEXT:     183:2|    8: <4, 0>                |      reloc @f0;
; CHECK-NEXT:     184:4|    4: <0, 0, 0>             |    var @g4, align 0,
; CHECK-NEXT:     185:7|    5: <1, 2>                |      initializers 2 {
; CHECK-NEXT:     187:3|    7: <3, 102, 111, 111>    |        {102, 111, 111}
; CHECK-NEXT:     191:5|    8: <4, 0>                |        reloc @f0;
; CHECK-NEXT:          |                             |      }
; CHECK-NEXT:     192:7|    4: <0, 0, 0>             |    var @g5, align 0,
; CHECK-NEXT:     194:2|    8: <4, 2>                |      reloc @g1;
; CHECK-NEXT:     195:4|    4: <0, 0, 0>             |    var @g6, align 0,
; CHECK-NEXT:     196:7|    9: <4, 6, 1>             |      reloc @g5 + 1;
; CHECK-NEXT:     198:7|    4: <0, 0, 0>             |    var @g7, align 0,
; CHECK-NEXT:     200:2|    9: <4, 2, 1>             |      reloc @g1 + 1;
; CHECK-NEXT:     202:2|    4: <0, 0, 0>             |    var @g8, align 0,
; CHECK-NEXT:     203:5|    9: <4, 2, 7>             |      reloc @g1 + 7;
; CHECK-NEXT:     205:5|    4: <0, 0, 0>             |    var @g9, align 0,
; CHECK-NEXT:     207:0|    9: <4, 2, 9>             |      reloc @g1 + 9;
; CHECK-NEXT:     209:0|    4: <0, 0, 0>             |    var @g10, align 0,
; CHECK-NEXT:     210:3|    9: <4, 5, 1>             |      reloc @g4 + 1;
; CHECK-NEXT:     212:3|    4: <0, 0, 0>             |    var @g11, align 0,
; CHECK-NEXT:     213:6|    9: <4, 5, 4>             |      reloc @g4 + 4;
; CHECK-NEXT:     215:6|  0: <65534>                 |  }
; CHECK-NEXT:     220:0|  1: <65535, 14, 3>          |  valuesymtab {  // BlockID = 14
; CHECK-NEXT:     228:0|    6: <1, 1, 122, 101, 114, |    @g0 : "zero";
; CHECK-NEXT:          |        111>                 |
; CHECK-NEXT:     233:1|    6: <1, 4, 112, 116, 114, |    @g3 : "ptr_to_func";
; CHECK-NEXT:          |        95, 116, 111, 95,    |
; CHECK-NEXT:          |        102, 117, 110, 99>   |
; CHECK-NEXT:     243:4|    6: <1, 5, 99, 111, 109,  |    @g4 : "compound";
; CHECK-NEXT:          |        112, 111, 117, 110,  |
; CHECK-NEXT:          |        100>                 |
; CHECK-NEXT:     251:5|    6: <1, 2, 98, 121, 116,  |    @g1 : "bytes";
; CHECK-NEXT:          |        101, 115>            |
; CHECK-NEXT:     257:4|    6: <1, 0, 102, 117, 110, |    @f0 : "func";
; CHECK-NEXT:          |        99>                  |
; CHECK-NEXT:     262:5|    6: <1, 3, 112, 116, 114, |    @g2 : "ptr_to_ptr";
; CHECK-NEXT:          |        95, 116, 111, 95,    |
; CHECK-NEXT:          |        112, 116, 114>       |
; CHECK-NEXT:     272:2|    6: <1, 8, 97, 100, 100,  |    @g7 : "addend_array1";
; CHECK-NEXT:          |        101, 110, 100, 95,   |
; CHECK-NEXT:          |        97, 114, 114, 97,    |
; CHECK-NEXT:          |        121, 49>             |
; CHECK-NEXT:     284:1|    6: <1, 9, 97, 100, 100,  |    @g8 : "addend_array2";
; CHECK-NEXT:          |        101, 110, 100, 95,   |
; CHECK-NEXT:          |        97, 114, 114, 97,    |
; CHECK-NEXT:          |        121, 50>             |
; CHECK-NEXT:     296:0|    6: <1, 10, 97, 100, 100, |    @g9 : "addend_array3";
; CHECK-NEXT:          |        101, 110, 100, 95,   |
; CHECK-NEXT:          |        97, 114, 114, 97,    |
; CHECK-NEXT:          |        121, 51>             |
; CHECK-NEXT:     307:7|    6: <1, 7, 97, 100, 100,  |    @g6 : "addend_ptr";
; CHECK-NEXT:          |        101, 110, 100, 95,   |
; CHECK-NEXT:          |        112, 116, 114>       |
; CHECK-NEXT:     317:4|    6: <1, 11, 97, 100, 100, |    @g10 : "addend_struct1";
; CHECK-NEXT:          |        101, 110, 100, 95,   |
; CHECK-NEXT:          |        115, 116, 114, 117,  |
; CHECK-NEXT:          |        99, 116, 49>         |
; CHECK-NEXT:     330:1|    6: <1, 6, 112, 116, 114> |    @g5 : "ptr";
; CHECK-NEXT:     334:4|    6: <1, 12, 97, 100, 100, |    @g11 : "addend_struct2";
; CHECK-NEXT:          |        101, 110, 100, 95,   |
; CHECK-NEXT:          |        115, 116, 114, 117,  |
