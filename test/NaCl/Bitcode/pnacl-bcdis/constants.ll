...
; CHECK-NEXT:     167:6|    4: <21, 0, 0>            |    @t8 = float ();
; CHECK-NEXT:     169:4|    4: <21, 0, 1>            |    @t9 = double ();
; CHECK-NEXT:     171:2|    4: <21, 0, 3>            |    @t10 = void ();
...
; CHECK-NEXT:     232:0|    6: <1, 0, 84, 101, 115,  |    @f0 : "TestIntegers";
; CHECK-NEXT:          |        116, 73, 110, 116,   |
; CHECK-NEXT:          |        101, 103, 101, 114,  |
; CHECK-NEXT:          |        115>                 |
; CHECK-NEXT:     243:1|    6: <1, 7, 71, 101, 116,  |    @f7 : "GetDoubleNegInf";
; CHECK-NEXT:          |        68, 111, 117, 98,    |
; CHECK-NEXT:          |        108, 101, 78, 101,   |
; CHECK-NEXT:          |        103, 73, 110, 102>   |
; CHECK-NEXT:     256:4|    6: <1, 2, 71, 101, 116,  |    @f2 : "GetFloatNan";
; CHECK-NEXT:          |        70, 108, 111, 97,    |
; CHECK-NEXT:          |        116, 78, 97, 110>    |
; CHECK-NEXT:     266:7|    6: <1, 3, 71, 101, 116,  |    @f3 : "GetFloatInf";
; CHECK-NEXT:          |        70, 108, 111, 97,    |
; CHECK-NEXT:          |        116, 73, 110, 102>   |
; CHECK-NEXT:     277:2|    6: <1, 5, 71, 101, 116,  |    @f5 : "GetDoubleNan";
; CHECK-NEXT:          |        68, 111, 117, 98,    |
; CHECK-NEXT:          |        108, 101, 78, 97, 110|
; CHECK-NEXT:          |        >                    |
; CHECK-NEXT:     288:3|    6: <1, 1, 84, 101, 115,  |    @f1 : "TestFloats";
; CHECK-NEXT:          |        116, 70, 108, 111,   |
; CHECK-NEXT:          |        97, 116, 115>        |
; CHECK-NEXT:     298:0|    6: <1, 6, 71, 101, 116,  |    @f6 : "GetDoubleInf";
; CHECK-NEXT:          |        68, 111, 117, 98,    |
; CHECK-NEXT:          |        108, 101, 73, 110,   |
; CHECK-NEXT:          |        102>                 |
; CHECK-NEXT:     309:1|    6: <1, 4, 71, 101, 116,  |    @f4 : "GetFloatNegInf";
; CHECK-NEXT:          |        70, 108, 111, 97,    |
...
; CHECK-NEXT:     344:0|      4: <1, 2>              |      i8:
; CHECK-NEXT:     344:7|      6: <4, 0>              |        %c0 = i8 0;
; CHECK-NEXT:     345:2|      5: <4, 10>             |        %c1 = i8 5;
; CHECK-NEXT:     346:5|      5: <4, 11>             |        %c2 = i8 -5;
; CHECK-NEXT:     348:0|      3: <3>                 |        %c3 = i8 undefined;
; CHECK-NEXT:     349:7|      4: <1, 4>              |      i16:
; CHECK-NEXT:     350:6|      6: <4, 0>              |        %c4 = i16 0;
; CHECK-NEXT:     351:1|      5: <4, 20>             |        %c5 = i16 10;
; CHECK-NEXT:     352:4|      5: <4, 21>             |        %c6 = i16 -10;
; CHECK-NEXT:     353:7|      3: <3>                 |        %c7 = i16 undefined;
; CHECK-NEXT:     355:6|      4: <1, 5>              |      i32:
; CHECK-NEXT:     356:5|      6: <4, 0>              |        %c8 = i32 0;
; CHECK-NEXT:     357:0|      5: <4, 40>             |        %c9 = i32 20;
; CHECK-NEXT:     358:3|      5: <4, 41>             |        %c10 = i32 -20;
; CHECK-NEXT:     359:6|      3: <3>                 |        %c11 = i32 undefined;
; CHECK-NEXT:     361:5|      4: <1, 6>              |      i64:
; CHECK-NEXT:     362:4|      6: <4, 0>              |        %c12 = i64 0;
; CHECK-NEXT:     362:7|      5: <4, 60>             |        %c13 = i64 30;
; CHECK-NEXT:     364:2|      5: <4, 61>             |        %c14 = i64 -30;
; CHECK-NEXT:     365:5|      3: <3>                 |        %c15 = i64 undefined;
; CHECK-NEXT:     367:4|      4: <1, 7>              |      i1:
; CHECK-NEXT:     368:3|      6: <4, 0>              |        %c16 = i1 0;
; CHECK-NEXT:     368:6|      5: <4, 3>              |        %c17 = i1 1;
...
; CHECK-NEXT:     436:0|      4: <1, 0>              |      float:
; CHECK-NEXT:     436:7|      7: <6, 0>              |        %c0 = float 0;
; CHECK-NEXT:     438:2|      7: <6, 1065353216>     |        %c1 = float 1;
; CHECK-NEXT:     443:5|      7: <6, 1088421888>     |        %c2 = float 7;
; CHECK-NEXT:     449:0|      7: <6, 1090519040>     |        %c3 = float 8;
; CHECK-NEXT:     454:3|      3: <3>                 |        %c4 = float undefined;
; CHECK-NEXT:     456:2|      4: <1, 1>              |      double:
; CHECK-NEXT:     457:1|      7: <6,                 |        %c5 = double 6;
; CHECK-NEXT:          |        4618441417868443648> |
; CHECK-NEXT:     466:4|      7: <6,                 |        %c6 = double 1;
; CHECK-NEXT:          |        4607182418800017408> |
; CHECK-NEXT:     475:7|      7: <6, 0>              |        %c7 = double 0;
; CHECK-NEXT:     477:2|      7: <6,                 |        %c8 = double 5;
...
; CHECK-NEXT:     528:0|      4: <1, 0>              |      float:
; CHECK-NEXT:     528:7|      7: <6, 2143289344>     |        %c0 = float nan;
...
; CHECK-NEXT:     560:0|      4: <1, 0>              |      float:
; CHECK-NEXT:     560:7|      7: <6, 2139095040>     |        %c0 = float inf;
...
; CHECK-NEXT:     592:0|      4: <1, 0>              |      float:
; CHECK-NEXT:     592:7|      7: <6, 4286578688>     |        %c0 = float -inf;
...
; CHECK-NEXT:     624:0|      4: <1, 1>              |      double:
; CHECK-NEXT:     624:7|      7: <6,                 |        %c0 = double nan;
...
; CHECK-NEXT:     660:0|      4: <1, 1>              |      double:
; CHECK-NEXT:     660:7|      7: <6,                 |        %c0 = double inf;
...
; CHECK-NEXT:     696:0|      4: <1, 1>              |      double:
; CHECK-NEXT:     696:7|      7: <6,                 |        %c0 = double -inf;
