...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 117, i8* %tmp) #0
  %tmp1 = load i8*, i8** %argv, align 4
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %vararg_lifetime_bitcast)
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %vararg_lifetime_bitcast)
  %tmp2 = load %struct._IO_FILE*, %struct._IO_FILE** bitcast ([4 x i8]* @stderr to %struct._IO_FILE**), align 4
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %vararg_lifetime_bitcast3)
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %vararg_lifetime_bitcast3)
  call void @llvm.lifetime.end.p0i8(i64 117, i8* %tmp) #0
  %tmp3 = getelementptr [119 x i8], [119 x i8]* %cupcake, i32 0, i32 0
  call void @llvm.lifetime.start.p0i8(i64 119, i8* %tmp3) #0
  %tmp4 = load i8*, i8** %argv, align 4
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %vararg_lifetime_bitcast6)
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %vararg_lifetime_bitcast6)
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %vararg_lifetime_bitcast10)
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %vararg_lifetime_bitcast10)
  call void @llvm.lifetime.end.p0i8(i64 119, i8* %tmp3) #0
  ret void
}
...
if.end.thread:                                    ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 119, i8* %tmp1) #0
...
if.end:                                           ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 119, i8* %tmp4) #0
...
if.end10:                                         ; preds = %if.then4, %if.end
  ...
  call void @llvm.lifetime.end.p0i8(i64 119, i8* %tmp8) #0
  ret void
}
